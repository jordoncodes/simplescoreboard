...
public abstract class AbstractSimpleScoreboard {
    ...
    protected AbstractSimpleScoreboard(String title) {
    ...
    protected void add(String text, Integer score) {
        if (removed.contains(score)) removed.remove(score);
    ...
    public void clear() {
        scores.forEach((text, score) -> remove(score, text, true));
    }

    public void makeScoresEmpty() {
        scores.forEach((text,score) -> remove(score, text, false));
    }


    protected boolean remove(Integer score, String text) {
        return remove(score, text, true);
    }

    protected boolean remove(Integer score, String n, boolean b) {
    ...
    protected String get(int score, String n) {
        String str = null;
